...
export function OfflineStrip({
  ...
  const sentence = !online
    ? pendingCount === 0
      ...
      : `Offline · ${items} are saved on this device and will send when the centre is back online.`
    : syncing
      ? `Sending · ${items} on their way.`
      : `${items} are saved on this device and have not reached the centre yet.`;
